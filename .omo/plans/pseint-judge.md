...
- [x] 25. Anticheat report UI (consumes todo 39 API)
...
- [x] 32. Contest page + live scoreboard
...
- [x] 33. Forums (per-problem threads) + moderation
...
- [x] 34. Engine container + hardened run wrapper
...
- [x] 36. docker-compose full stack
...
- [x] 38. Anticheat similarity engine (text-level)
...
- [x] 39. Similarity report API + threshold config
...
- [x] 40. Deployment hardening (HTTPS, backups, ops) — LOCAL dry-run; UNAM execution is post-plan
